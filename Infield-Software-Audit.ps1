...
$ApprovedListPath = "C:\Users\Production\Dropbox\Software Updates\IT-Admin\programs.txt"
$LogPath = "C:\DanceBUG\ESETDeploy\SoftwareAudit.log"
$LogFolder = "C:\DanceBUG\ESETDeploy"
