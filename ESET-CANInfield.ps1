...
# CONFIG
# ================================
$ZipUrl        = "https://drcvid-my.sharepoint.com/:u:/g/personal/chrishanr_dancebug_com/IQCk3Fyc75HHTLYZXw7cI-oaAfsQEqRe8M1zvjoJfKQQJl0?e=cKXYZo&download=1"
$WorkDir       = "C:\DanceBUG\ESETDeploy"
$ZipPath       = "$WorkDir\epi_win_live_installer-CAN-Infield.zip"
$InstallerPath = "$WorkDir\epi_win_live_installer-CAN-Infield.exe"
...
function Test-ESETActivated {
    ...
    if ($null -ne $reg.WebLicensePublicId -and 
        ...
        Write-Log "ESET is activated with CAN license."
        return $true
    }
