...
# CONFIG
# ================================
$ZipUrl        = "https://drcvid-my.sharepoint.com/:u:/g/personal/chrishanr_dancebug_com/IQAKKS9zsAcCT6c__MkUBNAFAVY-jFLqXtdwOysuGqivbXY?e=8gdnkW&download=1"
$WorkDir       = "C:\DanceBUG\ESETDeploy"
$ZipPath       = "$WorkDir\epi_win_live_installer-CAN-OFFICE.zip"
$InstallerPath = "$WorkDir\epi_win_live_installer-CAN-OFFICE.exe"
