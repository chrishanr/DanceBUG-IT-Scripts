...
$NewShortcutSource   = "C:\Users\Production\Dropbox\Software Updates\IT-Admin\Photo Manager - Training Mode.lnk"
...
$LogPath    = "C:\DanceBUG\ESETDeploy\PMTrainingMode.log"
