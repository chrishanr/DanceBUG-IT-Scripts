...
$LogPath    = "C:\ProgramData\IT-Admin\logs\PMStreamSetup.log"
...
Write-Log "========== Starting Photo Manager Deployment =========="
...
$AdaptiveCard = @{
    ...
    body    = @(
        @{
            type  = "TextBlock"
            text  = "Photo Manager Enabled on Stream Laptop"
            weight= "Bolder"
            size  = "Medium"
            color = "Attention"
        },
        ...
        @{
            type = "TextBlock"
            text = "The Photo Manager shortcut has been added to the Stream laptop."
            wrap = $true
        }
    )
